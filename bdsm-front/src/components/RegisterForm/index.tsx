  ...
  return (
    <div className={s.root}>
        <FormControl className={classes.input_form}>
            ...
            <TextField  className={classes.input} id="email" placeholder="email"
                    value={email}
                    onChange={(event) => dispatch(changeEmail(event.target.value))}/>
            <TextField  className={classes.input} id="username" placeholder="username"
                  value={login}
                  onChange={(event) => dispatch(changeLogin(event.target.value))}/>
            <TextField  className={classes.input} id="password" placeholder="password"
                  value={password}
